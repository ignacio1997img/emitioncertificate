...
class HomeController extends Controller
{
    ...
    public function codePhone(Request $request){
        ...
        Http::get('http://whatsapp.capresi.net/?number=591'.$request->phone.'&message=Hola *'.$people->first_name.' '.$people->last_name.'*.%0A%0A*GADBENI* %0A%0APara poder descargar su certificado has clic en el enlace de abajo.%0A👇👇%0Ahttps://certificate.trabajostop.com/certificate/download/'.$people->id);
